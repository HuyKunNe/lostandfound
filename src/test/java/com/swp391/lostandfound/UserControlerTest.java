...
public class UserControlerTest {
    ...
    @Order(1)
    void getAllChest1(){
        var listChests = userController.getAllUsers();
    ...
    @Order(4)
    void getUserByID1(){
        var userDataReturn = userController.getUserById(userData1.getUser().getId());
    ...
    @Order(5)
    void getUserByID2(){
        var userDataReturn = userController.getUserById(userData2.getUser().getId());
    ...
    @Order(6)
    void getUserByID3(){
        var chestDataReturn = userController.getUserById(10000);
    ...
    void getUserByPhone1(){
        var userDataReturn = userController.findUserByPhone(userData1.getUser().getPhoneNumber());
        assertThat(userDataReturn.getUser().getId()).isEqualTo(userData1.getUser().getId());
        assertThat(userDataReturn.getUser().getFirstName()).isEqualTo(userData1.getUser().getFirstName());
        assertThat(userDataReturn.getUser().getLastName()).isEqualTo(userData1.getUser().getLastName());
        assertThat(userDataReturn.getUser().getBirthday()).isEqualTo(userData1.getUser().getBirthday());
    ...
    void getUserByPhone2(){
        var userDataReturn = userController.findUserByPhone(userData2.getUser().getPhoneNumber());
        assertThat(userDataReturn.getUser().getId()).isEqualTo(userData2.getUser().getId());
        assertThat(userDataReturn.getUser().getFirstName()).isEqualTo(userData2.getUser().getFirstName());
        assertThat(userDataReturn.getUser().getLastName()).isEqualTo(userData2.getUser().getLastName());
        assertThat(userDataReturn.getUser().getBirthday()).isEqualTo(userData2.getUser().getBirthday());
    ...
    void getUserByPhone3(){
        var userDataReturn = userController.findUserByPhone("10000");
    ...
    void getUserByEmail1(){
        var userDataReturn = userController.findUserByEmail(userData1.getUser().getEmail());
        assertThat(userDataReturn.getUser().getId()).isEqualTo(userData1.getUser().getId());
        assertThat(userDataReturn.getUser().getFirstName()).isEqualTo(userData1.getUser().getFirstName());
        assertThat(userDataReturn.getUser().getLastName()).isEqualTo(userData1.getUser().getLastName());
        assertThat(userDataReturn.getUser().getBirthday()).isEqualTo(userData1.getUser().getBirthday());
    ...
    void getUserByEmail2(){
        var userDataReturn = userController.findUserByEmail(userData2.getUser().getEmail());
        assertThat(userDataReturn.getUser().getId()).isEqualTo(userData2.getUser().getId());
        assertThat(userDataReturn.getUser().getFirstName()).isEqualTo(userData2.getUser().getFirstName());
        assertThat(userDataReturn.getUser().getLastName()).isEqualTo(userData2.getUser().getLastName());
        assertThat(userDataReturn.getUser().getBirthday()).isEqualTo(userData2.getUser().getBirthday());
    ...
    void getUserByEmail3(){
        var userDataReturn = userController.findUserByEmail("10000");
        assertThat(userDataReturn.getMessage()).isEqualTo("User is not exist");
        assertThat(userDataReturn.getStatus()).isEqualTo("Fail");
    }
    ...
    void getUserByStudentCode1(){
        var userDataReturn = userController.findUserByStudentCode(userData1.getUser().getStudentCode());
        assertThat(userDataReturn.getUser().getId()).isEqualTo(userData1.getUser().getId());
        assertThat(userDataReturn.getUser().getFirstName()).isEqualTo(userData1.getUser().getFirstName());
        assertThat(userDataReturn.getUser().getLastName()).isEqualTo(userData1.getUser().getLastName());
        assertThat(userDataReturn.getUser().getBirthday()).isEqualTo(userData1.getUser().getBirthday());
    ...
    void getUserByStudentCode2(){
        var userDataReturn = userController.findUserByStudentCode(userData2.getUser().getStudentCode());
        assertThat(userDataReturn.getUser().getId()).isEqualTo(userData2.getUser().getId());
        assertThat(userDataReturn.getUser().getFirstName()).isEqualTo(userData2.getUser().getFirstName());
        assertThat(userDataReturn.getUser().getLastName()).isEqualTo(userData2.getUser().getLastName());
        assertThat(userDataReturn.getUser().getBirthday()).isEqualTo(userData2.getUser().getBirthday());
    ...
    void getUserByStudentCode3(){
        var userDataReturn = userController.findUserByStudentCode("10000");
        assertThat(userDataReturn.getMessage()).isEqualTo("User is not exist");
        assertThat(userDataReturn.getStatus()).isEqualTo("Fail");
    }
    ...
    void editUser1(){
        ...
        userData1 = userController.updateUser(userData1.getUser().getId(),userUpdateDTO);
    ...
    void editUser2(){
        ...
        userData2 = userController.updateUser(userData2.getUser().getId(),userUpdateDTO);
    ...
    void editUser3(){
        ...
        var chestDataReturn = userController.updateUser(100000,userUpdateDTO);
        assertThat(chestDataReturn.getMessage()).isEqualTo("User is not exist");
        assertThat(chestDataReturn.getStatus()).isEqualTo("Fail");
    }
    ...
    @Order(19)
    void getAllUser2(){
        var listUsersData = userController.getAllUsers();
    ...
    @Order(20)
    void deleteUser1(){
        userData1 = userController.deleteUserById(userData1.getUser().getId());
    ...
    @Order(21)
    void deleteUser2(){
        userData2 = userController.deleteUserById(userData2.getUser().getId());
    ...
    @Order(22)
    void deleteUser3(){
        var userData = userController.deleteUserById(10000);
